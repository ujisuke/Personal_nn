...
namespace Assets.Scripts.Enemy2
{
    public class Enemy2Move : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            objectMove.HeadToPlusImX(moveDirectionIm3.x >= _enemy2Parameter.StopMoveImDistanceFromPlayer);
            objectMove.HeadToMinusImX(moveDirectionIm3.x < -_enemy2Parameter.StopMoveImDistanceFromPlayer);
            objectMove.HeadToPlusImY(moveDirectionIm3.y >= _enemy2Parameter.StopMoveImDistanceFromPlayer);
            objectMove.HeadToMinusImY(moveDirectionIm3.y < -_enemy2Parameter.StopMoveImDistanceFromPlayer);
        ...
        {
            Vector3 moveDirectionIm3 = ObjectMove.CalculateImDirection3BetWeenTwoRePos3(transform.position, targetRePos3);
            return math.abs(moveDirectionIm3.x) <= _enemy2Parameter.StopMoveImDistanceFromPlayer && math.abs(moveDirectionIm3.y) <= _enemy2Parameter.StopMoveImDistanceFromPlayer;
        }
        ...
        public bool IsMissingPlayer()
        {
            ...
            Vector3 targetImPos3 = ObjectMove.ConvertToImPos3FromRePos3(fireRePos3)  + new Vector3(0f, 0f, _enemy2Parameter.SearchEnemy2Z);
            Vector3 playerImPos3 = ObjectMove.ConvertToImPos3FromRePos3(ObjectStorage.GetPlayerRePos3()) + new Vector3(0f, 0f, _enemy2Parameter.SearchedTargetZ);
            while(true)
            {
